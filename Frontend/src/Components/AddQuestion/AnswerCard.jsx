...
export default function AnswerCard({ answer, setAnswer }) {
    ...
    const setNumericalAnswer = (val) => setAnswer(prev => ({ ...prev, correct: val }));
                                ...
                                {!option.imagePreview && (
                                    <>
                                        ...
                                        <button
                                            ...
                                            className="px-2.5 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-400 hover:border-blue-300 hover:text-blue-400 transition-all"
                                        >
